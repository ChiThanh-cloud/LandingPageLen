...
export function OrderReceivedEmail({
  ...
  return (
    <EmailLayout preheader={preheader}>
      ...
      <tr>
        <td style={{ borderTop: "1px solid #e8edf2", color: "#64748b", fontSize: "14px", lineHeight: "21px", padding: "20px 28px 24px" }}>
          Tiệm Len Nhà Tiny<br />
          <a href="https://lentiny.xyz" style={{ color: "#1d4ed8", textDecoration: "none" }}>lentiny.xyz</a>
        </td>
      </tr>
    </EmailLayout>
  );
